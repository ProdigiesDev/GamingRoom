...
public class GestionMembreTest {
    public static void main(String [] args){
        ...
        Membre m3 = new Membre("Manita","Yasmine",d,Membre.Genre.Femme,"51852630","yasmine.manita@esprit.tn","123456","sonia.jpg",Membre.Role.Membre,true);
        ...
        Membre c3 = new Membre("Kacem","Mokhtar",d,Membre.Genre.Homme,"98910835","mokhtar.kacem@esprit.tn","123456","mokhtar.jpg",Membre.Role.Coach,"je suis mokhtar fan de...",false);
