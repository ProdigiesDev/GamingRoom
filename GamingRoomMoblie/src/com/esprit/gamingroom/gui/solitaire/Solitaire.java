...
import com.esprit.gamingroom.gui.Reaction.AvisListAdminForm;
 ...
 * @author Dah
 */
public class Solitaire extends Form{
    ...
    public  Solitaire() {
        ...
        this.addComponent(createPlacementContainer(solitairContainer));
        this.addComponent(solitairContainer);
        ...
        for(Card c : shuffledDeck) {
            ...
            solitairContainer.addComponent(SolitaireLayout.DECK_0, cmp);
                ...
                getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, ev-> new HomeForm(theme).showBack());
